...
var animalRegisterHandler = /*#__PURE__*/function () {
  ...
  return function animalRegisterHandler(_x) {
    return _ref.apply(this, arguments);
  };
}();

var obtainPetInfo = function obtainPetInfo() {
  ...
  var deathDate = formDate[2].value;
  var favorites = ["".concat(formDate[3].value), "".concat(formDate[4].value), "".concat(formDate[5].value)];
  return {
    petName: petName,
    deathDate: deathDate,
    favorites: favorites,
...
var displayAnimalRegisterPage = function displayAnimalRegisterPage() {
  ...
  animalRegister();
  document.querySelector('.logout').addEventListener('click', _utils_common__WEBPACK_IMPORTED_MODULE_0__.logout);
  document.querySelector('.animal-register-button').addEventListener('click', animalRegisterHandler); // document.querySelector('.animal-register-button').addEventListener('click', );
};
...
var animalRegister = function animalRegister() {
  (0,_animal_register__WEBPACK_IMPORTED_MODULE_0__.default)();
};
...
var displayMainPage = function displayMainPage() {
  ...
  moveCarousel();
  document.querySelector('.logout').addEventListener('click', _utils_common__WEBPACK_IMPORTED_MODULE_1__.logout);
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (userInfo) {
              ...
              user.updateUserInfo(userInfo.data.payload.email, userInfo.data.username, userInfo.data.payload._id, userInfo.data.token);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (userInfo) {
              console.log(userInfo);
              user.updateUserInfo(email, username, userInfo.data.user._id, userInfo.data.token);
...
var User = /*#__PURE__*/function () {
  ...
  _createClass(User, [{
    key: "updateUserInfo",
    value: function updateUserInfo(email, username, id, token) {
      this.username = username;
      this.email = email;
      this.token = token;
      this.id = id;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_0___default()({
              method: 'post',
              url: _utils_constants__WEBPACK_IMPORTED_MODULE_1__.URL_LOGIN,
              data: {
                email: email,
                password: password
              }
...
var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(email, password, username) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_0___default()({
              method: 'post',
              url: _utils_constants__WEBPACK_IMPORTED_MODULE_1__.URL_REGISTER,
              data: {
                email: email,
                password: password,
                username: username
